...
export declare class BlisDialog extends builder.Dialog {
    ...
    static luisCallback: (text: string, predictedEntities: PredictedEntity[], memoryManager: ClientMemoryManager) => ScoreInput;
    static blisCallback: (text: string, memoryManager: ClientMemoryManager) => string | builder.Message;
