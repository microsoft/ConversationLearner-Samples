...
var Server = (function () {
    ...
    Server.Init = function () {
        ...
        this.server.on('restifyError', function (req, res, err, cb) {
            BlisDebug_1.BlisDebug.Error(err, "ResiftyError");
            req.log.error(err);
            return cb();
        });
        this.server.listen(5000, function (err) {
            if (err) {
                BlisDebug_1.BlisDebug.Error(err, "Server/Init");
            }
            else {
                BlisDebug_1.BlisDebug.Log("SDK Service " + _this.server.name + " listening to " + _this.server.url);
            }
        });
        //========================================================
        // State
