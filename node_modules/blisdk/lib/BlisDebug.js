...
var BlisDebug = (function () {
    ...
    BlisDebug.Error = function (error, context) {
        if (context === void 0) { context = ""; }
        var text = "ERROR: " + (error ? Utils_1.Utils.ErrorString(error, context) : "No details");
        BlisDebug.Log(text);
        return text;
    };
    ...
    BlisDebug.logging = "client"; // "client flow memory";
    return BlisDebug;
}());
