...
var BlisContext = (function () {
    ...
    BlisContext.CreateAsync = function (bot, session) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        context = new BlisContext(bot, session);
                        _a = context;
                        return [4 /*yield*/, BlisMemory_1.BlisMemory.InitMemory(context.session)];
                    case 1:
                        _a.memory = _b.sent();
    ...
    BlisContext.prototype.Init = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, BlisMemory_1.BlisMemory.InitMemory(this.session)];
                    case 1:
                        _a.memory = _b.sent();
                        return [2 /*return*/];
                }
