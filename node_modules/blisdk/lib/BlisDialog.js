...
var BlisDialog = (function (_super) {
    ...
    function BlisDialog(bot, options) {
        ...
        try {
            ...
            BlisDebug_1.BlisDebug.Log("Initialization complete....");
        }
        catch (error) {
            BlisDebug_1.BlisDebug.Error(error, "Dialog Constructor");
        }
        return _this;
    }
    // Create singleton
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var errComponent, memory, context, validationError, inTeach, app, sessionResponse, sessionId, userInput, extractResponse, error_1, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        errComponent = "ProcessInput";
                        memory = null;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 16, , 18]);
                        BlisDebug_1.BlisDebug.Verbose("Process Input...");
                        return [4 /*yield*/, BlisContext_1.BlisContext.CreateAsync(this.bot, session)];
                    case 2:
                        context = _a.sent();
                        memory = context.Memory();
                        validationError = this.validationError();
                        if (!validationError) return [3 /*break*/, 4];
                        BlisDebug_1.BlisDebug.Error(validationError);
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, validationError)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4: return [4 /*yield*/, memory.BotState.InTeach()];
                    case 5:
                        inTeach = _a.sent();
                        return [4 /*yield*/, memory.BotState.App()];
                    case 6:
                        app = _a.sent();
                        if (!!app) return [3 /*break*/, 11];
                        if (!this.options.appId) return [3 /*break*/, 11];
                        BlisDebug_1.BlisDebug.Log("Selecting app: " + this.options.appId);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.GetApp(this.options.appId, null)];
                    case 7:
                        app = _a.sent();
                    ...
                    case 10:
                        app = _a.sent();
                        _a.label = 11;
                    case 11: return [4 /*yield*/, memory.BotState.SessionId()];
                    case 12:
                        sessionId = _a.sent();
                        userInput = new blis_models_1.UserInput({ text: session.message.text });
                        if (!!inTeach) return [3 /*break*/, 15];
                        BlisDebug_1.BlisDebug.Verbose("Calling entity extractor");
                    ...
                    case 16:
                        error_1 = _a.sent();
                        msg = BlisDebug_1.BlisDebug.Error(error_1, errComponent);
