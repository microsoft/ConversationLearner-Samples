...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var errComponent, memory, context, validationError, inTeach, app, sessionResponse, error_1, msg, sessionId, userInput, extractResponse, error_2, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 9:
                        error_1 = _a.sent();
                        console.log("ERROR: Failed to start session.  Check that your appId is valid.");
                    ...
                    case 12:
                        ...
                        BlisDebug_1.BlisDebug.Log("Calling entity extractor");
                    ...
                    case 16:
                        error_2 = _a.sent();
                        msg = BlisDebug_1.BlisDebug.Error(error_2, errComponent);
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, msg)];
                    case 17:
                        _a.sent();
                        return [3 /*break*/, 18];
