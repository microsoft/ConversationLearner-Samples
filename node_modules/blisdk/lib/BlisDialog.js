...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, memory, validationError, inTeach, app, sessionResponse, error_1, msg, msg, sessionId, userInput, extractResponse, error_2, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (!this.options.appId) return [3 /*break*/, 10];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 7, , 9]);
                    ...
                    case 10:
                        msg = "ERROR: No application has been set.  Set BLIS_APP_ID in your deployed environment.";
                        console.log(msg);
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, msg)];
                    case 11:
                        _a.sent();
