...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, memory, inTeach, app, sessionResponse, error_1, msg, sessionId, userInput, extractResponse, error_2, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        app = _a.sent();
                        if (!!app) return [3 /*break*/, 10];
                        if (!this.startAppId) return [3 /*break*/, 8];
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 7]);
