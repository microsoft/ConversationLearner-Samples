...
var BlisDialog = (function (_super) {
    ...
    function BlisDialog(bot, options) {
        ...
        try {
            ...
            _this.startAppId = options.appId;
            ...
            if (!options.appId) {
                console.log("No appId set.  Assuming localhost...");
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var context, memory, inTeach, app, sessionResponse, sessionId, userInput, extractResponse, error_1, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        app = _a.sent();
                        if (!!app) return [3 /*break*/, 6];
                        if (!this.startAppId) return [3 /*break*/, 4];
                        console.log("Selecting app: " + this.startAppId);
                        return [4 /*yield*/, BlisClient_1.BlisClient.client.StartSession(this.startAppId)];
                    case 3:
                    ...
                    case 4:
                        ;
                        console.log("ERROR: No application has been set.");
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, "No application has been set.  Set BLIS_APP_ID in your deployed environment.")];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                    case 6: return [4 /*yield*/, memory.BotState.SessionId()];
                    case 7:
                        sessionId = _a.sent();
                        userInput = new blis_models_1.UserInput({ text: session.message.text });
                        if (!!inTeach) return [3 /*break*/, 13];
                        _a.label = 8;
                    case 8:
