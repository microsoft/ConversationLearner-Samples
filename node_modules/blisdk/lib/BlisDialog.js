...
var BlisDialog = (function (_super) {
    ...
    BlisDialog.prototype.ProcessInput = function (session, cb) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var memory, context, validationError, inTeach, app, sessionResponse, error_1, msg, sessionId, userInput, extractResponse, error_2, msg, error_3, msg;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        memory = null;
                    ...
                    case 16:
                        error_2 = _a.sent();
                        msg = BlisDebug_1.BlisDebug.Error(error_2, "ProcessExtraction");
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, msg)];
                    case 17:
                        _a.sent();
                        return [3 /*break*/, 18];
                    ...
                    case 19:
                        error_3 = _a.sent();
                        msg = BlisDebug_1.BlisDebug.Error(error_3, "ProcessInput");
                        return [4 /*yield*/, Utils_1.Utils.SendMessage(this.bot, memory, msg)];
                    case 20:
                        _a.sent();
                        return [3 /*break*/, 21];
