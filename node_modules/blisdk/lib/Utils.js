    ...
    Utils.ErrorString = function (error) {
        try {
            if (!error) {
                ...
                return JSON.stringify(error.stringify);
            }
            else if (error.body.message) {
                return error.body.message;
            }
            else if (error.body.errorMessages) {
                return error.body.errorMessages.join();
            }
            ...
            return "Error Parsing Failed: " + Object.prototype.toString.call(e) + " " + JSON.stringify(e);
        }
    };
